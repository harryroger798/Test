...
**File layout (v3.5.17 — current):**
```
snapleads-downloads/
  SnapLeads.Setup.3.5.17.exe             (Windows NSIS installer, ~340MB)
  SnapLeads-3.5.17-arm64-mac.zip         (macOS zip, ~278MB)
```
...
backend/
  app/
    ...
    services/
      ...
      database_search.py        -- DuckDB S3 queries against 190M+ leads (1380+ lines, v3.5.17 three-bug fix)
...
### v3.5.17 Three-Bug Fix (Claude Opus 4.6 Analysis)
...
4. **Runtime Extraction (v3.5.17):** `_ensure_bundled_httpfs()` reads runtime DuckDB version, extracts to exact `v{version}/{platform}/` path
5. **Path Fix (v3.5.17):** Backslashes normalized to forward slashes before SET
6. **Error Surfacing (v3.5.17):** Full diagnostic logging on all failures
...
### Current URLs (v3.5.17)

| Platform | Download URL |
|----------|-------------|
| Windows | `https://f005.backblazeb2.com/file/snapleads-downloads/SnapLeads.Setup.3.5.17.exe` |
| macOS | `https://f005.backblazeb2.com/file/snapleads-downloads/SnapLeads-3.5.17-arm64-mac.zip` |

### SHA256 Hashes (v3.5.17)
