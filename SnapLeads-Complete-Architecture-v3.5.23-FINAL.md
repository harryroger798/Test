...
**File layout (v3.5.23 — current):**
```
snapleads-downloads/
  SnapLeads-Setup-3.5.23.exe             (Windows NSIS installer, ~340MB)
  SnapLeads-3.5.23-arm64-mac.zip         (macOS zip, ~278MB)
```
...
backend/
  app/
    ...
    services/
      ...
      database_search.py        -- DuckDB S3 queries against 190M+ leads (2026 lines, v3.5.20 Python httpfs download fix + autoload)
