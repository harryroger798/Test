...
21. [Version History (v3.4.3 — v3.5.27)](#21-version-history)
...
**File layout (v3.5.28 — current):**
```
snapleads-downloads/
  v3.5.28/
    SnapLeads-Setup-3.5.28.exe           (Windows NSIS installer, ~657MB — includes Patchright Chromium + driver)
    SnapLeads-3.5.28-arm64-mac.zip       (macOS zip, ~278MB)
  v3.5.27/
    SnapLeads-Setup-3.5.27.exe           (Windows NSIS installer, ~657MB)
    SnapLeads-3.5.27-arm64-mac.zip       (macOS zip, ~278MB)
```
...
backend/
  app/
    ...
    services/
      ...
      live_scrapers.py          -- 12-platform live scrapers (1500+ lines, v3.5.28: Facebook multi-source pipeline):
                                   Reddit, WhatsApp, Facebook (v3.5.28: 6-source pipeline), Telegram, Twitter,
      ...
      ## Google Dorking ##
      google_dorking.py         -- Multi-engine dorking with 10+ templates per platform + DuckDuckGo via Patchright (v3.5.28: zero CAPTCHA) + HTTP fallback (v3.5.26: httpx+BS4 when Patchright unavailable)
...
User enters keyword + selects platform(s)
    ...
    Waterfall: Serper API > Multi-engine > Patchright→DuckDuckGo (v3.5.28)
          |
...
### Current URLs (v3.5.27)

| Platform | Download URL |
|----------|-------------|
| Windows | `https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.27/SnapLeads-Setup-3.5.27.exe` |
| macOS | `https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.27/SnapLeads-3.5.27-arm64-mac.zip` |

### SHA256 Hashes (v3.5.27)

| File | SHA256 |
|------|--------|
| Windows .exe | `7792515e6599a377afa9011de96d4b3ed6f6e3eb5d0b4032a268ab87e88fd5e2` |
| macOS .zip | `99d466a6ba8c645be71471089157d2d4d7b965e2b5093d9dbdd90d9f0183cf62` |

### VirusTotal Scan URLs (v3.5.27)
...
*End of Consolidated Architecture Document — v3.5.28*
