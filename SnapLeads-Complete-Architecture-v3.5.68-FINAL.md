# SnapLeads Complete Architecture Document — v3.5.68

**Date:** March 23, 2026
**Version:** 3.5.68
**Status:** Production-ready (lifetime pricing removed — monthly/yearly only)

---

## 1. What's New in v3.5.68

### Lifetime Pricing Removal + ProGate Text Fix

**Change:** Completely removed "lifetime" billing cycle from all 3 repositories. Only monthly and yearly plans remain. Also fixed ProGate component text from "12 platforms" to "20 platforms".
...
## 3. Version History (v3.5.32 — v3.5.68)
...
|------|---------|-----------|
| `harryroger798/social-lead-extractor-pro` | Desktop Electron app (backend + frontend) + weekly sync | **PR #154 (v3.5.68 — ProGate + lifetime removal)** |
| `harryroger798/snapleads-platform` | License server API + Marketing website (getsnapleads.store) | **PR #152 (v3.5.68 — lifetime removal + LifetimePage deleted)** |
