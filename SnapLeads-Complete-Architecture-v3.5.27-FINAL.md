...
**File layout (v3.5.27 — current):**
```
snapleads-downloads/
  v3.5.27/
    SnapLeads-Setup-3.5.27.exe           (Windows NSIS installer, ~657MB — includes Patchright Chromium + driver)
    SnapLeads-3.5.27-arm64-mac.zip       (macOS zip, ~278MB)
  v3.5.26/
    SnapLeads-Setup-3.5.26.exe           (Windows NSIS installer, ~622MB)
    SnapLeads-3.5.26-arm64-mac.zip       (macOS zip, ~278MB)
```
...
backend/
  app/
    ...
    services/
      ...
      ## Google Dorking ##
      google_dorking.py         -- Multi-engine dorking with 10+ templates per platform + HTTP fallback (v3.5.26: httpx+BS4 when Patchright unavailable)
...
*End of Consolidated Architecture Document — v3.5.27*
