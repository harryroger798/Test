...
**File layout (v3.5.14 — current):**
```
snapleads-downloads/
  SnapLeads-Setup-3.5.14.exe             (Windows NSIS installer, ~330MB)
  SnapLeads-3.5.14-mac.zip               (macOS zip, ~273MB)
```
...
backend/
  app/
    ...
    services/
      ...
      database_search.py        -- DuckDB S3 queries against 190M+ leads (1380+ lines, v3.5.14 httpfs fix)
...
### Current URLs (v3.5.13)

| Platform | Download URL |
|----------|-------------|
| Windows | `https://f005.backblazeb2.com/file/snapleads-downloads/SnapLeads-Setup-3.5.13.exe` |
| macOS | `https://f005.backblazeb2.com/file/snapleads-downloads/SnapLeads-3.5.13-arm64-mac.zip` |

### SHA256 Hashes (v3.5.13)

| File | SHA256 |
|------|--------|
| Windows .exe | `21ddc818b40c6ce38810000a261e9d5f93a17f08286da90c75a78e6c3da40041` |
| macOS .zip | `523694cf48bb62614e7d39cbdea04446d1c8766e2ec0f87f2315a6588035f6b1` |

### VirusTotal Scan URLs (v3.5.13)

| File | VirusTotal URL |
|------|---------------|
| Windows .exe | `https://www.virustotal.com/gui/file/21ddc818b40c6ce38810000a261e9d5f93a17f08286da90c75a78e6c3da40041` |
| macOS .zip | `https://www.virustotal.com/gui/file/523694cf48bb62614e7d39cbdea04446d1c8766e2ec0f87f2315a6588035f6b1` |
