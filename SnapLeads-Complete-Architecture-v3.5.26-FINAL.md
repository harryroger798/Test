...
| Headless Browser | Patchright (Chromium, bundled in Windows build v3.5.26+) |
...
**File layout (v3.5.26 — current):**
```
snapleads-downloads/
  v3.5.26/
    SnapLeads-Setup-3.5.26.exe           (Windows NSIS installer, ~622MB — includes Patchright Chromium)
...
backend/
  app/
    ...
    services/
      ...
      patchright_engine.py      -- Patchright Chromium launcher with PyInstaller bundle detection (sys._MEIPASS), runtime auto-install fallback for macOS
...
### Current URLs (v3.5.26)

| Platform | Download URL |
|----------|-------------|
| Windows | `https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.26/SnapLeads-Setup-3.5.26.exe` |
| macOS | `https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.26/SnapLeads-3.5.26-arm64-mac.zip` |

### SHA256 Hashes (v3.5.26)
...
*End of Consolidated Architecture Document — v3.5.26*
