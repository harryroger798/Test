        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <a href="https://textshift.blog" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition" onClick={() => setMobileMenuOpen(false)}>Blog</a>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex items-center justify-center md:justify-end gap-6 text-gray-500 text-sm">
              ...
              <a href="https://textshift.blog" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">Blog</a>
