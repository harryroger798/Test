...
**File layout (v3.5.24 — current):**
```
snapleads-downloads/
  SnapLeads-Setup-3.5.24.exe             (Windows NSIS installer, ~340MB)
  SnapLeads-3.5.24-arm64-mac.zip         (macOS zip, ~278MB)
```
