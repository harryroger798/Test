...
**File layout (v3.5.20 — current):**
```
snapleads-downloads/
  SnapLeads-Setup-3.5.20.exe             (Windows NSIS installer, ~340MB)
  SnapLeads-3.5.20-arm64-mac.zip         (macOS zip, ~278MB)
```
