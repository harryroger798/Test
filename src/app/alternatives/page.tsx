    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-6xl">
          <img src="/characters/rage_sword.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-0 bottom-0 hidden w-[280px] opacity-70 md:block lg:w-[350px]" />
