...
export default function ScanPage() {
  ...
  return (
    <div className="relative mx-auto max-w-4xl px-4 py-12">
      <img src="/characters/rage_laptop.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-2 bottom-2 hidden max-h-[140px] w-auto opacity-15 md:block" />
      <motion.div
