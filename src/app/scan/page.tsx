...
export default function ScanPage() {
  ...
  return (
    <div className="relative mx-auto max-w-4xl px-4 py-12">
      <img src="/characters/rage_laptop.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-4 top-4 hidden max-h-[180px] w-auto opacity-70 md:block" />
      <motion.div
