...
export default function PricingPage() {
  ...
  return (
    <div className="relative mx-auto max-w-5xl px-4 py-12">
      <img src="/characters/rage_celebrate.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-0 top-10 hidden w-[320px] opacity-70 md:block lg:w-[380px]" />
      <img src="/characters/rage_trophy.png" alt="" aria-hidden className="pointer-events-none select-none absolute left-0 bottom-10 hidden w-[180px] opacity-40 md:block" />
      <motion.div
