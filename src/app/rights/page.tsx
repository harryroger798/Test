    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          <img src="/characters/rage_shield.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-0 -bottom-4 hidden w-[320px] opacity-80 md:block lg:w-[400px]" />
