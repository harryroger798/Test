  ...
  return (
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-24">
        ...
        <img src="/characters/rage_shield.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-4 bottom-0 z-10 hidden max-h-[220px] w-auto opacity-80 md:block" />
