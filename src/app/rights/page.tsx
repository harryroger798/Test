    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          <img src="/characters/rage_shield.png" alt="" aria-hidden className="pointer-events-none select-none absolute -right-10 -bottom-10 hidden w-[420px] opacity-80 md:block lg:w-[520px]" />
