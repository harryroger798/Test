...
export default function DashboardPage() {
  ...
  return (
    <div className="relative mx-auto max-w-6xl px-4 py-12">
      <img src="/characters/rage_laptop.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-0 top-0 hidden w-[280px] opacity-50 lg:block" />
