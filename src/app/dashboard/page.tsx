...
export default function DashboardPage() {
  ...
  return (
    <div className="relative mx-auto max-w-6xl px-4 py-12">
      <img src="/characters/rage_laptop.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-4 top-4 hidden max-h-[220px] w-auto opacity-40 lg:block" />
