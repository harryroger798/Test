    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-6xl">
          <img src="/characters/rage_mode.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-2 top-0 hidden max-h-[200px] w-auto opacity-60 md:block" />
