...
export default function CheckoutPage({
  ...
  return (
    <div className="relative mx-auto max-w-2xl px-4 py-12">
      <img src="/characters/rage_face.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-2 top-4 hidden max-h-[160px] w-auto opacity-50 md:block" />
