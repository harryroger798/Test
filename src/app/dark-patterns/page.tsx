    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-6xl">
          <img src="/characters/rage_face.png" alt="" aria-hidden className="pointer-events-none select-none absolute -right-10 -bottom-6 hidden w-[380px] opacity-70 md:block lg:w-[460px]" />
