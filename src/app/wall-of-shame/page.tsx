    ...
    <div>
      <div className="relative overflow-hidden px-4 py-16 md:py-20">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative mx-auto max-w-7xl">
          <img src="/characters/rage_point.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-0 bottom-0 hidden w-[280px] opacity-80 md:block lg:w-[350px]" />
