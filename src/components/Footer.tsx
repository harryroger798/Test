...
export default function Footer() {
  return (
    <footer className="relative border-t border-[#1E1E1E] bg-[#0A0A0A] pb-20 md:pb-0 overflow-hidden">
      <img src="/characters/rage_peek.png" alt="" aria-hidden className="pointer-events-none select-none absolute right-6 bottom-8 hidden max-h-[150px] w-auto opacity-40 lg:block" />
