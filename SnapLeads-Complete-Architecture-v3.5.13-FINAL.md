...
**File layout (v3.5.13 — current):**
```
snapleads-downloads/
  SnapLeads-Setup-3.5.13.exe             (Windows NSIS installer, ~330MB)
  SnapLeads-3.5.13-arm64-mac.zip         (macOS zip, ~273MB)
```
...
backend/
  app/
    ...
    services/
      ...
      database_search.py        -- DuckDB S3 queries against 190M+ leads (1322 lines)
